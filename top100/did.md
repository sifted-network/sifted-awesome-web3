...
| 2 | [not-paid](https://github.com/kleampa/not-paid) | 15,585 | 1,035 | JavaScript | 0 | Client did not pay? Add opacity to the body tag and decrease it every day until their site completely fades away | 2025-04-28 |
...
| 7 | [DidierStevensSuite](https://github.com/DidierStevens/DidierStevensSuite) | 2,506 | 595 | Python | 0 | Please no pull requests for this repository. Thanks! | 2026-06-14 |
...
| 23 | [obsidian-osint-templates](https://github.com/WebBreacher/obsidian-osint-templates) | 796 | 132 | - | 0 | These templates are suggestions of how the Obsidian notetaking tool can be used during an OSINT investigation. The example data in those files should allow you to make some connections (see what I did... | 2026-06-14 |
...
| 54 | [anp](https://github.com/agent-network-protocol/anp) | 327 | 52 | Python | 10 | Our vision is to provide communication capabilities for intelligent agents, allowing them to connect with each other to form a collaborative network of intelligent agents. | 2026-07-02 |
...
| 62 | [diff-diff](https://github.com/igerber/diff-diff) | 278 | 40 | Python | 1 | Difference-in-Differences causal inference in Python. Callaway-Sant'Anna, Synthetic DiD, Honest DiD, event studies. sklearn-like API, validated against R. | 2026-07-04 |
