...
## 1. Blame bitcoin's tumble on rising inflation, not Strategy, 10xResearch argues
...
📖 [Read original article](https://www.coindesk.com/markets/2026/06/08/blame-bitcoin-s-tumble-on-rising-inflation-not-strategy-10xresearch-argues)

---

## 2. CoinDesk 20 performance update: NEAR gains 12.3% as almost all assets trade higher
...
📖 [Read original article](https://www.coindesk.com/coindesk-indices/2026/06/08/coindesk-20-performance-update-near-gains-12-3-as-almost-all-assets-trade-higher)

---

## 3. MetaMask launches AI agent wallet with built-in security for crypto trades

**Author:** Margaux Nijkerk  
**Published:** 6/8/2026, 1:00:00 PM  
**Categories:** Tech, Ethereum News, ConsenSys, News  
...
## 4. Bitmine bought the dip, making its biggest ether purchase in 2026 as prices tanked
...
**Published:** 6/8/2026, 12:05:01 PM  
...
## 7. A crucial bitcoin market indicator is signaling that the worst of the crypto crash might be over
...
## 8. Bybit challenges Wall Street with a massive push into tokenized U.S. stock IPOs
...
## 9. Crypto's recovery remains elusive as SpaceX, Anthropic IPOs loom
...
## 10. Bitcoin holds steady after Sunday's rally, though full-fledged reversal may take longer
...
## 11. Gold slips below 200-day moving average offering glimmer of hope for bitcoin bulls
...
## 12. U.S. inflation, European Central Bank rate decision: Crypto Week Ahead
...
## 13. CME is letting traders bet on bitcoin volatility, not price, and two firms have already placed bets
...
## 14. Zcash bounces 45% as developers propose new 'Ironwood' upgrade
...
## 15. XRP steadies above $1.10 to bounce from four-month lows
...
## 16. Bitcoin's rally to $63,700 triggers $504 million losses for short sellers, most since late April
...
## 17. Bitcoin spikes, then dumps, from $63,700 as analysts assess Strategy's next BTC moves
...
## 18. Bitcoin falls back below $63,000 as Iran-Israel trade strikes and Korean stocks crash
